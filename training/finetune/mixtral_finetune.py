"""QLoRA fine-tuning — WOS Mixtral 8x7B models.

Usage:
  python mixtral_finetune.py --model coding
  python mixtral_finetune.py --model meeting
  python mixtral_finetune.py --model main
"""
...
def main():
    ...
    print(f"\n{'='*60}")
    print(f"Training WOS-{args.model.upper()} (Mixtral 8x7B)")
    ...
    print(f"\n{'='*60}")
    print(f"WOS-{args.model.upper()} (MIXTRAL) COMPLETE!")
